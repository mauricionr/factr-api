...
/*!40101 SET @saved_cs_client     = @@character_set_client */;
 SET character_set_client = utf8mb4 ;
CREATE TABLE `wallet` (
  `trustID` varchar(100) NOT NULL,
  `password` varchar(100) NOT NULL,
  `value` float unsigned zerofill NOT NULL DEFAULT '000000000000',
  PRIMARY KEY (`trustID`),
  UNIQUE KEY `trustID_UNIQUE` (`trustID`)
...
INSERT INTO `wallet` VALUES ('dfgtfhuyjgyhbfthjug','drgdrgdrgrd',000000001150),('gfhfghfdbdbdf','asddfghfhersfsasdasdsa',000000000960),('kjsdfkhjdsfhjsdfjk','sdfksdjfkjsdfds',000000000950),('sadasdas','asdasdasdsa',000000000940);
/*!40000 ALTER TABLE `wallet` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Dumping events for database 'factr'
--

--
-- Dumping routines for database 'factr'
--
...
-- Dump completed on 2018-06-10  1:26:59
